...
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E>
  ...
  /**
   * Returns a {@code Collector} that collects elements into an {@code ImmutableSortedMultiset},
   * sorted by the specified {@code Comparator}.
   */
  public static <E> Collector<E, ?, ImmutableSortedMultiset<E>> toImmutableSortedMultiset(
      Comparator<? super E> comparator) {
    checkNotNull(comparator);
    return Collectors.collectingAndThen(
        Collectors.toCollection(() -> new TreeMultiset<E>(comparator)),
