...
public abstract class Ordering<T> implements Comparator<T> {
  // "Overrides" of static methods on Comparator.

  /**
   * Returns an {@code Ordering} that orders inputs by mapping them to a {@code Comparable}
   * sort key, and ordering by the natural ordering on the keys.
   *
   * <p>The ordering is equivalent to {@code Ordering.from(Comparator.comparing(function))}.
   */
  public static <T, C extends Comparable<? super C>> Ordering<T>
      comparing(Function<? super T, ? extends C> function) {
    return comparing(function, Ordering.natural());
  }

  /**
   * Returns an {@code Ordering} that sorts inputs by mapping them to a sort key,
   * and ordering by the specified comparator on the keys.
   *
   * <p>The ordering is equivalent to
   * {@code Ordering.from(Comparator.comparing(function, comparator))}.
   */
  public static <T, C> Ordering<T> comparing(Function<? super T, ? extends C> function,
      Comparator<? super C> comparator) {
    return new ComparingOrdering<T, C>(function, comparator);
  }

  /**
   * Returns an {@code Ordering} that orders inputs by mapping them to an {@code int} sort key.
   *
   * <p>The ordering is equivalent to {@code Ordering.from(Comparator.comparingInt(function))}.
   */
  public static <T> Ordering<T> comparingInt(ToIntFunction<? super T> function) {
    return new ComparingIntOrdering<T>(function);
  }

  /**
   * Returns an {@code Ordering} that orders inputs by mapping them to a {@code long} sort key.
   *
   * <p>The ordering is equivalent to {@code Ordering.from(Comparator.comparingLong(function))}.
   */
  public static <T> Ordering<T> comparingLong(ToLongFunction<? super T> function) {
    return new ComparingLongOrdering<T>(function);
  }

  /**
   * Returns an {@code Ordering} that orders inputs by mapping them to a {@code double} sort key.
   *
   * <p>The ordering is equivalent to {@code Ordering.from(Comparator.comparingDouble(function))}.
   */
  public static <T> Ordering<T> comparingDouble(ToDoubleFunction<? super T> function) {
    return new ComparingDoubleOrdering<T>(function);
  }
  ...
  public <F> Ordering<F> onResultOf(Function<F, ? extends T> function) {
    return comparing(function, this);
  }
