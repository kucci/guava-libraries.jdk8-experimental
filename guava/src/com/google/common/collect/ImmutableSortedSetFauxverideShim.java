...
abstract class ImmutableSortedSetFauxverideShim<E> extends ImmutableSet<E> {
  ...
  /**
   * Not supported. Use {@link ImmutableSortedSet#toImmutableSortedSet(Comparator)}, which offers
   * better type-safety, instead. This method exists only to hide
   * {@link ImmutableSet#toImmutableSet} from consumers of {@code ImmutableSortedSet}.
   *
   * @throws UnsupportedOperationException always
   * @deprecated Use {@link ImmutableSortedSet#toImmutableSortedSet(Comparator)}, which offers
   *     better type-safety.
   */
  @Deprecated
