...
public final class Multimaps {
  ...
  public static <K, V1, V2> Multimap<K, V2> transformValues(
    ...
    BiFunction<K, V1, V2> transformer = Maps.asEntryTransformer(function);
   ...
   *   BiFunction<String, Integer, String> transformer =
   *       (key, value) -> key + value;
   *   Multimap<String, String> transformed =
  ...
  private static class TransformedEntriesMultimap<K, V1, V2>
    ...
    Map<K, Collection<V2>> createAsMap() {
      return Maps.transformEntries(fromMultimap.asMap(),
          (key, valueCollection) -> transform(key, valueCollection));
    }
