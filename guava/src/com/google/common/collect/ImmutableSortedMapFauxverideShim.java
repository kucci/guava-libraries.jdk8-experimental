...
abstract class ImmutableSortedMapFauxverideShim<K, V>
  ...
  /**
   * Not supported. Use {@link ImmutableSortedMap#toImmutableSortedMap} instead. This method exists only to
   * hide {@link ImmutableMap#toImmutableMap} from consumers of {@code ImmutableSortedMap}.
   *
   * @throws UnsupportedOperationException always
   * @deprecated Use {@link ImmutableSortedMap#toImmutableSortedMap} instead.
   */
  @Deprecated public static <T, K, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableMap(
