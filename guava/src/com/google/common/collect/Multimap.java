...
public interface Multimap<K, V> {
  ...
  /**
   * Performs the given action for each entry in the multimap, or until the
   * action throws an exception.  Entries are processed in the iteration
   * order of {@code entries()} unless otherwise specified.
   *
