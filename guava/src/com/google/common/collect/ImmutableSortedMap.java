...
public abstract class ImmutableSortedMap<K, V>
  ...
  /**
   * Returns a {@code Collector} that accumulates entries into an {@code ImmutableSortedMap},
   * sorted by the specified comparator, where the keys and values are the results of applying the
   * provided functions to the input elements.
   *
  ...
  public static <T, K, V> Collector<T, ?, ImmutableSortedMap<K, V>> toImmutableSortedMap(
    ...
    return Collectors.collectingAndThen(
        Collectors.toMap(keyFunction, valueFunction, rejectCollisions(),
