...
abstract class ImmutableSortedMultisetFauxverideShim<E> extends ImmutableMultiset<E> {
  ...
  /**
   * Not supported. Use {@link ImmutableSortedMultiset#toImmutableSortedMultiset(Comparator)},
   * which offers better type-safety, instead. This method exists only to hide
   * {@link ImmutableMultiset#toImmutableMultiset} from consumers of
   * {@code ImmutableSortedMultiset}.
   *
   * @throws UnsupportedOperationException always
   * @deprecated Use {@link ImmutableSortedMultiset#toImmutableSortedMultiset(Comparator)}, which
