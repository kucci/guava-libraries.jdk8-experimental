...
public final class Iterators {
  ...
  public static boolean removeAll(
    ...
    return removeIf(removeFrom, elementsToRemove::contains);
  }
  ...
  public static boolean retainAll(
    ...
    return removeIf(removeFrom, e -> !elementsToRetain.contains(e));
  }
   ...
   * {@code predicate.test(Iterators.get(iterator, i))} returns {@code true},
  ...
  static <F, T> ListIterator<T> transform(final ListIterator<F> fromIterator,
      final Function<? super F, ? extends T> function) {
    return new TransformedListIterator<F, T>(fromIterator) {
      @Override
      T transform(F from) {
        return function.apply(from);
      }
  ...
  static <F, T> UnmodifiableIterator<T> transform(final UnmodifiableIterator<F> fromIterator,
      final Function<? super F, ? extends T> function) {
