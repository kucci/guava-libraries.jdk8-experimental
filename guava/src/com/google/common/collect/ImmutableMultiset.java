...
public abstract class ImmutableMultiset<E> extends ImmutableCollection<E>
  ...
  /**
   * Returns a {@code Collector} that collects elements into an {@code ImmutableMultiset}.
   */
  public static <E> Collector<E, ?, ImmutableMultiset<E>> toImmutableMultiset() {
    return Collectors.collectingAndThen(
        Collectors.toCollection(LinkedHashMultiset::<E>create),
  ...
  private final class EntrySet extends ImmutableSet<Entry<E>> {
    ...
    @Override
    public void forEach(Consumer<? super Entry<E>> consumer) {
