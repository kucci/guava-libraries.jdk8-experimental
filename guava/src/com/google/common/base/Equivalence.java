...
public abstract class Equivalence<T> implements BiPredicate<T, T> {
  ...
  /**
   * Returns the same result as {@code equivalent(a, b)}.  Provided for compatibility with
   * {@code BiPredicate}.
   *
   * @deprecated Prefer {@code equivalent}.
   */
  @Override
  @Deprecated
  public final boolean test(@Nullable T a, @Nullable T b) {
    return equivalent(a, b);
  }

  // TODO(user): add an Equivalence.and(Equivalence) overload
   ...
   * @since 10.0
   */
  public final <F> Equivalence<F> onResultOf(java.util.function.Function<F, ? extends T> function) {
