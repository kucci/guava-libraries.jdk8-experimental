...
public final class Functions {
  ...
  public static <A, B, C> Function<A, C> compose(
      java.util.function.Function<B, C> g, java.util.function.Function<A, ? extends B> f) {
    return new FunctionComposition<A, B, C>(g, f);
  }

  private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
    private final java.util.function.Function<B, C> g;
    private final java.util.function.Function<A, ? extends B> f;
   ...
   */
  public static <T> Function<T, Boolean> forPredicate(java.util.function.Predicate<T> predicate) {
  ...
  private static class PredicateFunction<T> implements Function<T, Boolean>, Serializable {
    ...
    private PredicateFunction(java.util.function.Predicate<T> predicate) {
   ...
   */
  @Beta
  public static <T> Function<Object, T> forSupplier(java.util.function.Supplier<T> supplier) {
  ...
  private static class SupplierFunction<T> implements Function<Object, T>, Serializable {
    ...
    private SupplierFunction(java.util.function.Supplier<T> supplier) {
