...
public class ImmutableSetTest extends AbstractImmutableSetTest {
  ...
  public void testCollector() {
    BiPredicate<ImmutableSet<Integer>, ImmutableSet<Integer>> equiv =
        Equivalence.equals().onResultOf(ImmutableSet<Integer>::asList)
            .and(Equivalence.equals());
    CollectorTester.of(ImmutableSet.<Integer>toImmutableSet(), equiv)
        .expectCollects(ImmutableSet.of())
        .expectCollects(ImmutableSet.of(1, 2, 3), 1, 2, 3)
        .expectCollects(ImmutableSet.of(2, 1, 3), 2, 1, 3, 2, 3, 3);
  }
