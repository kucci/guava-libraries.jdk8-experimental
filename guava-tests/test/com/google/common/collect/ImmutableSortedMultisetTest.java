...
public class ImmutableSortedMultisetTest extends TestCase {
  ...
  public void testCollector() {
    BiPredicate<ImmutableSortedMultiset<Integer>, ImmutableSortedMultiset<Integer>> equiv =
        Equivalence.equals().onResultOf(
                (ImmutableSortedMultiset<Integer> multiset) -> multiset.entrySet().asList())
            .and(Equivalence.equals().onResultOf(ImmutableSortedMultiset<Integer>::comparator))
            .and(Equivalence.equals());
    CollectorTester
        .of(ImmutableSortedMultiset.<Integer>toImmutableSortedMultiset(Ordering.natural()), equiv)
        .expectCollects(ImmutableSortedMultiset.of())
        .expectCollects(ImmutableSortedMultiset.of(1, 2, 3), 1, 2, 3)
        .expectCollects(new ImmutableSortedMultiset.Builder<Integer>(Ordering.natural())
            .addCopies(2, 2)
            .addCopies(1, 1)
            .addCopies(3, 3)
            .build(), 2, 1, 3, 2, 3, 3);
