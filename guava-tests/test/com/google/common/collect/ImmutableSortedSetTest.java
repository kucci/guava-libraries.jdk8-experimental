...
public class ImmutableSortedSetTest extends AbstractImmutableSetTest {
  ...
  public void testCollector() {
    BiPredicate<ImmutableSortedSet<Integer>, ImmutableSortedSet<Integer>> equiv =
        Equivalence.equals().onResultOf(ImmutableSortedSet<Integer>::asList)
            .and(Equivalence.equals().onResultOf(ImmutableSortedSet<Integer>::comparator))
            .and(Equivalence.equals());
    CollectorTester.of(ImmutableSortedSet.<Integer>toImmutableSortedSet(Ordering.natural()), equiv)
        .expectCollects(ImmutableSortedSet.of())
        .expectCollects(ImmutableSortedSet.of(1, 2, 3), 1, 2, 3)
        .expectCollects(ImmutableSortedSet.of(2, 1, 3), 2, 1, 3, 2, 3, 3);
  }
